  ...
  return (
    <main className="bg-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container px-4 pt-16 pb-10 relative">
          <div className="flex items-center gap-3 mb-4 animate-fade-in">
            <FileText className="h-6 w-6 text-primary" />
            <span className="text-sm font-medium text-neutral-600">Documento Legal</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-extrabold text-neutral-dark mb-4 animate-fade-in">
            Termos de Uso — Talker Flow
          </h1>
          <p className="text-neutral-700 animate-fade-in">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3 animate-fade-in">
            <button
              ...
              aria-label="Imprimir ou salvar em PDF estes termos"
            >
      ...
      <section id="conteudo" className="py-12">
        <div className="container px-4 grid lg:grid-cols-[280px_1fr] gap-10">
          {/* Sumário (desktop) */}
          ...
          <article className="prose max-w-none">
            {/* estilo base de texto dentro do artigo */}
            <div className="space-y-10 text-neutral-800">
              ...
              <section id="sec-1" className="scroll-mt-24">
                ...
                <div className="space-y-3 leading-relaxed">
                  ...
                  <p>
                    1.2. Ao criar conta, acessar ou utilizar a Plataforma, você (“Cliente” ou “Usuário”) declara ter
                    lido, compreendido e aceitado integralmente estes Termos e a Política de Privacidade aplicável.
                  </p>
                  <p>
              ...
              <section id="sec-6" className="scroll-mt-24">
                ...
                <div className="space-y-3 leading-relaxed">
                  <p>6.1. Upgrades passam a valer imediatamente (ou no ciclo seguinte, conforme política comercial). Downgrades entram em vigor no ciclo subsequente e podem implicar perda de funcionalidades/limites.</p>
                </div>
              </section>
              ...
              <section id="sec-7" className="scroll-mt-24">
                ...
                <div className="space-y-3 leading-relaxed">
                  ...
                  <p>
                    7.2. O Cliente é responsável por obter autorizações, templates, números e conformidade de uso.
                    A Talker Flow não responde por indisponibilidades, alterações de regras, bloqueios ou custos impostos por terceiros.
                  </p>
                </div>
              </section>
              ...
              <section id="sec-10" className="scroll-mt-24">
                ...
                <div className="space-y-3 leading-relaxed">
                  <p>10.1. A Talker Flow envidará esforços comercialmente razoáveis para manter os Serviços disponíveis e seguros. Eventuais janelas de manutenção poderão ocorrer, preferencialmente fora de horários de pico.</p>
      ...
      {/* Print styles: deixa limpo no PDF */}
      <style jsx>{`
        @media print {
          nav, aside, .btn-primary, [href="#contato"], [aria-label="Imprimir ou salvar em PDF estes termos"], .bg-gradient-to-r { display: none !important; }
          main, section, article { padding: 0 !important; }
