        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden md:flex justify-center animate-fade-in">
            <div className="relative">
              ...
              {/* Smartphone Frame */}
              <div className="relative mx-auto border-gray-800 bg-gray-800 border-[14px] rounded-[2.5rem] h-[640px] w-[300px] shadow-xl overflow-hidden">
                {/* Notch */}
                ...
                {/* Entire chat area with input included */}
                <div
                ...
                >
                  <div
                    ref={chatRef}
                    className="flex-1 overflow-y-auto space-y-4 p-4 bg-[#e4e1de] bg-opacity-60"
                  >
                    {/* Mensagens */}
                    ...
                    <div className="bg-[#dcf8c6] p-3 rounded-lg rounded-tr-none ml-auto max-w-[80%] shadow-sm">
                      <p className="text-sm">
                        Sim, esse horario é uma correria mesmo nas sextas! Pode ser de manahã sim sem problemas. De manhã vou ter na Terça, às 9h ou 11:15h Qual destes fica melhor?
                      </p>
                      <div className="flex items-center justify-end gap-1 mt-1">
                  ...
                  {/* Campo de digitação visível e bem posicionado */}
