        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center animate-fade-in">
            <div className="relative">
              ...
              <div className="relative mx-auto border-gray-800 bg-black border-[14px] rounded-[2.5rem] h-[540px] w-[260px] md:h-[640px] md:w-[310px] shadow-xl overflow-hidden scale-[0.95]">
